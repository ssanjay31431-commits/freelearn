...
export const PortfolioPage = () => {
  ...
  const COLOR_VARIANTS_DATABASE = {
    Websites: [
      { id: 'w1', name: '01 VibeForge Digital Agency Website', bgTag: 'bg-indigo-50 text-indigo-700 border-indigo-200', accent: '#4F46E5', image: '/web_sample_1.png', desc: 'VibeForge dark digital agency website portal with interactive service cards, stat counters, and custom quote CTAs.' },
      { id: 'w2', name: '02 ShopEase E-Commerce Website', bgTag: 'bg-purple-50 text-purple-900 border-purple-200', accent: '#8B5CF6', image: '/web_sample_2.png', desc: 'ShopEase modern white e-commerce web app with 60% OFF promo banner, product categories, and best seller grid.' },
      { id: 'w3', name: '03 Flavoria Gourmet Restaurant Website', bgTag: 'bg-amber-50 text-amber-900 border-amber-200', accent: '#F59E0B', image: '/web_sample_3.png', desc: 'Flavoria dark luxury restaurant website with interactive menu, online table booking, and special dishes showcase.' },
      { id: 'w4', name: '04 Arun Kumar Developer Portfolio Website', bgTag: 'bg-indigo-50 text-indigo-900 border-indigo-200', accent: '#6366F1', image: '/web_sample_4.png', desc: 'Sleek dark developer & UI/UX designer portfolio website with service badges, CV download, and contact links.' },
      { id: 'w5', name: '05 BizPro Corporate Business Website', bgTag: 'bg-blue-50 text-blue-900 border-blue-200', accent: '#2563EB', image: '/web_sample_5.png', desc: 'BizPro corporate enterprise website with executive banner, 500+ project counters, and quote request modal.' },
    ],
    Posters: [
      { id: 'p1', name: 'Smart Digital Blood Bank Management Platform Poster', bgTag: 'bg-rose-50 text-rose-900 border-rose-200', accent: '#E11D48', image: '/poster_blood_bank_1.jpg', desc: 'Comprehensive digital blood donation platform poster featuring project overview, donor dashboard, tech stack, and benefits.' },
      { id: 'p2', name: 'Emergency Blood Donation & Management Poster', bgTag: 'bg-red-50 text-red-900 border-red-200', accent: '#DC2626', image: '/poster_blood_bank_2.jpg', desc: 'Full architecture and workflow poster for emergency blood donation platform with UI module previews.' },
      { id: 'p3', name: 'Full-Stack NGO Blood Bank Administration Poster', bgTag: 'bg-rose-50 text-rose-900 border-rose-200', accent: '#991B1B', image: '/poster_blood_bank_3.jpg', desc: 'Professional B.Tech project poster showcasing system architecture, website screenshots, and tech stack.' },
      { id: 'p4', name: 'National Tech Symposium & Hackathon Poster', bgTag: 'bg-cyan-50 text-cyan-900 border-cyan-200', accent: '#06B6D4', image: '/poster_sample_1.png', desc: 'High-impact 300DPI print-ready symposium poster with VibeForge logo, cash prizes, and tech icons.' },
      { id: 'p5', name: 'VibeForge Agency Digital Services Poster', bgTag: 'bg-indigo-50 text-indigo-900 border-indigo-200', accent: '#4F46E5', image: '/poster_sample_2.png', desc: 'Clean white corporate poster with 8 feature icons, QR code, and WhatsApp links.' },
    ],
    Videos: [
      { id: 'v1', name: 'Cyberpunk Robotic Animation Reel', bgTag: 'bg-pink-50 text-pink-900 border-pink-200', accent: '#EC4899', isVideo: true, videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-futuristic-robotic-face-41489-large.mp4', posterImg: 'https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?auto=format&fit=crop&w=800&q=80', desc: 'High-retention video reel with glowing 3D cyberpunk animation and beat sync.' },
      { id: 'v2', name: 'Mobile App Demo Reel Edit', bgTag: 'bg-cyan-50 text-cyan-900 border-cyan-200', accent: '#06B6D4', isVideo: true, videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-hands-holding-a-smartphone-with-a-green-screen-41477-large.mp4', posterImg: 'https://images.unsplash.com/photo-1536240478700-b869070f9279?auto=format&fit=crop&w=800&q=80', desc: 'Mobile app screen replacement and dynamic motion graphic video edit.' },
      { id: 'v3', name: 'Video Editing Suite Workflow Reel', bgTag: 'bg-slate-100 text-slate-900 border-slate-300', accent: '#1E293B', isVideo: true, videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-editing-video-on-a-computer-screen-41484-large.mp4', posterImg: 'https://images.unsplash.com/photo-1518173946687-a4c8a383392e?auto=format&fit=crop&w=800&q=80', desc: 'Behind-the-scenes video editing workflow reel with sound design.' },
      { id: 'v4', name: 'Cyberpunk Coding & Neon Reel', bgTag: 'bg-amber-50 text-amber-900 border-amber-200', accent: '#F59E0B', isVideo: true, videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-typing-on-a-keyboard-with-cyberpunk-lights-41482-large.mp4', posterImg: 'https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?auto=format&fit=crop&w=800&q=80', desc: 'High-speed keyboard typing reel with glowing neon lighting.' },
      { id: 'v5', name: 'DJ Night & Festival Promo Reel', bgTag: 'bg-emerald-50 text-emerald-900 border-emerald-200', accent: '#10B981', isVideo: true, videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-dj-playing-music-at-a-club-41474-large.mp4', posterImg: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=800&q=80', desc: 'High-energy DJ party video edit with strobe light effects.' },
    ],
    APK: [
      { id: 'a1', name: '01 Developer Portfolio Mobile App', bgTag: 'bg-indigo-50 text-indigo-700 border-indigo-200', accent: '#4F46E5', image: '/apk_sample_1.png', desc: 'VibeForge developer portfolio Flutter mobile app with dark theme, service badges, and CV download.' },
      { id: 'a2', name: '03 Food Delivery Mobile App', bgTag: 'bg-slate-100 text-slate-900 border-slate-300', accent: '#0F172A', image: '/apk_sample_2.png', desc: 'VibeForge campus food ordering Android APK featuring restaurant listings, live discount coupons, and tracking.' },
      { id: 'a3', name: '06 Workout & Fitness Tracker App', bgTag: 'bg-emerald-50 text-emerald-900 border-emerald-200', accent: '#10B981', image: '/apk_sample_3.png', desc: 'Dark theme fitness & workout tracker mobile app with step counters, calorie metrics, and HIIT plans.' },
      { id: 'a4', name: '07 VibeForge Learn Education App', bgTag: 'bg-purple-50 text-purple-900 border-purple-200', accent: '#8B5CF6', image: '/apk_sample_4.png', desc: 'Clean white e-learning course platform mobile app with course ratings, wishlist, and certificate generator.' },
      { id: 'a5', name: '10 Notes & Task Management App', bgTag: 'bg-cyan-50 text-cyan-900 border-cyan-200', accent: '#06B6D4', image: '/apk_sample_5.png', desc: 'Minimalist dark notes & daily task management app UI with pinned items, categories, and quick action FAB.' },
    ],
  };
  ...
  const portfolioItems = [
    ...
    },
    {
      ...
      title: 'Athi Foundation Smart Blood Bank Management Poster',
      category: 'Posters',
      colorTheme: 'Blood Bank Red',
      colorBadge: 'bg-rose-50 text-rose-700 border-rose-200',
      price: 100,
      image: '/poster_blood_bank_1.jpg',
      description: 'High-impact B.Tech project poster detailing emergency blood donation, donor dashboard, and system architecture.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          ...
          <p className="text-slate-600 text-sm sm:text-base">
            Click <strong>Preview 5 Samples</strong> to browse authentic website screenshots, mobile app UIs, real blood bank posters, and playable videos.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
          {filteredItems.map((item) => (
            <div
              key={item.id}
              className="bg-white rounded-3xl overflow-hidden border border-slate-200 hover:border-indigo-400 transition-all duration-300 transform hover:-translate-y-1 shadow-sm hover:shadow-xl flex flex-col justify-between group"
            >
              <div>
              ...
              <div className="p-6 pt-0 space-y-2">
                <button
                  ...
                  className="w-full py-3 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-extrabold text-xs border border-indigo-200 transition-all flex items-center justify-center gap-2 cursor-pointer mb-2 shadow-sm"
                >
              ...
              <div className="lg:col-span-5 space-y-4">
                ...
                <div className="space-y-2 pt-2">
                  <button
                    ...
                    className="w-full py-3.5 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-extrabold flex items-center justify-center gap-2 shadow-md transition-all cursor-pointer"
                  >
